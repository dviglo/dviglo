...
public:
    ...
    std::shared_ptr<VertexBuffer> GetInstancingBuffer() const { return dynamicInstancing_ ? instancingBuffer_ : nullptr; }
...
private:
    ...
    std::shared_ptr<VertexBuffer> instancingBuffer_;
    /// Default material.
