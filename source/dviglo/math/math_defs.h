...
inline float RandomNormal(float meanValue, float variance) { return rand_standard_normal() * sqrtf(variance) + meanValue; }
...
DV_API void SinCos(float angle, float& sin, float& cos);
