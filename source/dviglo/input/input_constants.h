...
// TODO: Переделать в enum class GamepadButton
enum GamepadButton : unsigned
{
    CONTROLLER_BUTTON_A = SDL_GAMEPAD_BUTTON_A,
    CONTROLLER_BUTTON_B = SDL_GAMEPAD_BUTTON_B,
    CONTROLLER_BUTTON_X = SDL_GAMEPAD_BUTTON_X,
    CONTROLLER_BUTTON_Y = SDL_GAMEPAD_BUTTON_Y,
    ...
    CONTROLLER_BUTTON_LEFT_STICK = SDL_GAMEPAD_BUTTON_LEFT_STICK,
    CONTROLLER_BUTTON_RIGHT_STICK = SDL_GAMEPAD_BUTTON_RIGHT_STICK,
    CONTROLLER_BUTTON_LEFT_SHOULDER = SDL_GAMEPAD_BUTTON_LEFT_SHOULDER,
    CONTROLLER_BUTTON_RIGHT_SHOULDER = SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER,
...
// TODO: Переделать в enum class GamepadAxis
enum ControllerAxis : unsigned
{
    ...
    CONTROLLER_AXIS_LEFT_TRIGGER = SDL_GAMEPAD_AXIS_LEFT_TRIGGER,
    CONTROLLER_AXIS_RIGHT_TRIGGER = SDL_GAMEPAD_AXIS_RIGHT_TRIGGER,
};
