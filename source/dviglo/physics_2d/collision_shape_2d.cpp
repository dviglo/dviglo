...
void CollisionShape2D::register_object()
{
    ...
    DV_ACCESSOR_ATTRIBUTE("Mask Bits", GetMaskBits, SetMaskBits, 0, AM_DEFAULT);
    DV_ACCESSOR_ATTRIBUTE("Group Index", GetGroupIndex, SetGroupIndex, 0, AM_DEFAULT);
    DV_ACCESSOR_ATTRIBUTE("Density", GetDensity, SetDensity, 0.0f, AM_DEFAULT);
    DV_ACCESSOR_ATTRIBUTE("Friction", GetFriction, SetFriction, 0.2f, AM_DEFAULT);
    DV_ACCESSOR_ATTRIBUTE("Restitution", GetRestitution, SetRestitution, 0.0f, AM_DEFAULT);
}
