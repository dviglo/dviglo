...
if (CMAKE_PROJECT_NAME STREQUAL Urho3D AND TARGET Urho3D)
    ...
    set (URHO3D_INCLUDE_DIRS ${URHO3D_HOME}/include ${URHO3D_HOME}/include/dviglo/ThirdParty)
    if (URHO3D_PHYSICS)
    ...
    if (URHO3D_LUA)
        ...
        list (APPEND URHO3D_INCLUDE_DIRS ${URHO3D_HOME}/include/dviglo/ThirdParty/Lua${JIT})
    endif ()
    ...
    if (NOT URHO3D_64BIT EQUAL URHO3D_FOUND_64BIT OR NOT URHO3D_LIB_TYPE STREQUAL URHO3D_FOUND_LIB_TYPE OR NOT URHO3D_BASE_INCLUDE_DIR MATCHES "^${URHO3D_HOME}/include/dviglo$")
    ...
    find_path (URHO3D_BASE_INCLUDE_DIR dviglo.h PATH_SUFFIXES ${PATH_SUFFIX} ${SEARCH_OPT} DOC "Urho3D include directory")
    ...
    foreach (ABI_64BIT RANGE ${URHO3D_64BIT} 0)
        ...
        elseif (URHO3D_LIBRARIES)
            ...
            if (URHO3D_COMPILE_RESULT)
                ...
                file (READ ${URHO3D_BASE_INCLUDE_DIR}/dviglo.h EXPORT_HEADER)
